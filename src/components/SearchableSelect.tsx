                      ...
                      {isEditing ? (
                        ...
                        <>
                          <button
                            ...
                            className="flex-1 text-left font-bold cursor-pointer pr-2 truncate"
                          >
                            {opt.label}
                          </button>
                          {(onEditOption || onDeleteOption) && (
                            <div className={`flex items-center gap-1 transition-opacity shrink-0 ${
                              deletingValue === opt.value ? 'opacity-100' : 'opacity-80 group-hover:opacity-100 focus-within:opacity-100'
                            }`}>
                                ...
                                <>
                                  {onEditOption && (
                                    <button
                                      ...
                                      onClick={(e) => {
                                        ...
                                        setEditingValue(opt.label || opt.value);
                                        setDeletingValue(null);
                                      }}
                                      className="p-1 text-blue-500 hover:text-blue-700 hover:bg-blue-100/60 rounded-md cursor-pointer"
                                      title="កែប្រែ (Edit)"
                                    >
                                  ...
                                  {onDeleteOption && (
                                    <button
                                      ...
                                      className="p-1 text-rose-500 hover:text-rose-700 hover:bg-rose-100/60 rounded-md cursor-pointer"
                                      title="លុប (Delete)"
                                    >
