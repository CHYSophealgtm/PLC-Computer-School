...
export default function TeachersTab(props: any) {
  ...
  const [teachPhotoUrl, setTeachPhotoUrl] = React.useState("");
                      ...
                      <div className="space-y-2 relative z-10">
                        ...
                        <div className="flex items-center gap-3 text-[10px] font-black text-slate-400 mt-2">
                          <span className="flex items-center gap-1">
                            ...
                            {uiLang === "kh" ? "ប្រុស: " : "M: "}{formatLangNum(teachers.filter(t => t && t.gender === "Male").length)}
                          </span>
                          <span className="text-slate-200">|</span>
                          <span className="flex items-center gap-1">
                            <span className="w-1.5 h-1.5 rounded-full bg-pink-500"></span>
                            {uiLang === "kh" ? "ស្រី: " : "F: "}{formatLangNum(teachers.filter(t => t && t.gender === "Female").length)}
                          </span>
                        </div>
                      </div>
                                        ...
                                        <div className="flex items-center gap-3.5">
                                          ...
                                          <div className="relative shrink-0">
                                            <div className={`w-8 h-8 rounded-xl bg-amber-100 border border-amber-300 flex items-center justify-center text-base shadow-xs overflow-hidden relative`}>
                                              {teacher.photoUrl || (teacher as any).photo ? (
                                                <img src={teacher.photoUrl || (teacher as any).photo} alt={teacher.nameKh} className="w-full h-full object-cover" referrerPolicy="no-referrer" />
                                              ) : (
                                        ...
                                        <div className="flex gap-2 justify-end">
                                          ...
                                          <button
                                            onClick={() => {
                                              ...
                                              setTeachPhotoUrl((teacher as any).photoUrl || "");
                                              setIsTeacherModalOpen(true);
                                            }}
                            ...
                            {editingTeacherId && (
                              <div className="bg-slate-50 border border-slate-200 rounded-xl overflow-hidden mt-6 mb-4">
                                ...
                                <div className="p-2 space-y-1 max-h-[200px] overflow-y-auto">
                                  {(() => {
                                    const t = teachers.find(t => t && t.id === editingTeacherId);
                        ...
                        >
                          ...
                          <div className="p-6 space-y-6 max-h-[60vh] overflow-y-auto">
                            ...
                            <div className="flex items-center gap-4 bg-slate-50 p-4 rounded-xl border border-slate-200/65">
                              <div className={`w-14 h-14 rounded-full font-black text-lg flex items-center justify-center border shadow-3xs bg-primary-100 text-primary-700 border-primary-200 overflow-hidden shrink-0`}>
                                {selectedTeacher.photoUrl || (selectedTeacher as any).photo ? (
                                  <img src={selectedTeacher.photoUrl || (selectedTeacher as any).photo} alt={selectedTeacher.nameKh} className="w-full h-full object-cover" referrerPolicy="no-referrer" />
                                ) : (
                                  <span>{selectedTeacher.gender === "Female" ? "👩‍🏫" : "👨‍🏫"}</span>
                                )}
                              </div>
